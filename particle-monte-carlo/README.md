...
**Experiment goal**: to measure the mean lifetime of an decaying particle from detector data in a realistic geometry with finite acceptance and detector smearing. <br>
